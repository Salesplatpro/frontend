          ...
          <div className="lg:hidden cursor-pointer">
            {toggleBtn ? (
              <>
                ...
                />
                <div className="bg-grey-900 h-[100vh] absolute inset-0 z-20 scale-up-tr">
                  <ul className="flex flex-col items-center justify-center h-full text-white space-y-8 capitalize">
                    <li className="font-semibold text-lg text-primary capitalize decoration-0 leading-[18px] font-raleway hover:text-white">
                      <Link
                        to="/"
                    ...
                    <li>
                      {user.isLoggedIn ? (
                        <button
                          className="font-semibold text-lg text-primary capitalize decoration-0 leading-[18px] font-raleway hover:text-white"
                          type="button"
                          onClick={() => {
                            handleLogout()
                            setToggleBtn(false)
